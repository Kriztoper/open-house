    ...
    <!-- Modal content-->
      <div class="modal-content gap">
        ...
        <div class="modal-body">
          <form class="form-horizontal" role="form" method="POST" action="{{ url('/tokens') }}">
          <input type="hidden" name="_token" value="{{ csrf_token() }}">
          <input type="text" class="form-control gap" placeholder="First Name...">
          <input type="text" class="form-control gap" placeholder="Last Name...">
          <input type="text" class="form-control gap" placeholder="Student Number...">
        </div>
